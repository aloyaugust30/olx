...
<li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Adverts</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										 <ul id="menu-academico-sub" >
<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url(); ?>admin/new_post">New Ad</a></li>
<li id="menu-academico-boletim" ><a href="<?php echo base_url(); ?>admin/all_ads">View All Adverts</a></li>
