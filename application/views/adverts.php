                  ...
                  <div class="col-md-9 col-md-push-3 col-lg-9 col-sx-12">
                     ...
                     <div class="row no-gutter">
                        ...
                        <div class="posts-masonry">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 post-box2">
                              ...
                              <a href="<?php echo base_url('adverts/ad-details/'.$row['slug']); ?>">
                                 ...
                                 <div class="short-description-1 ">
                                    ...
                                    <!-- Ad Title -->
                                    <h3>
                                       <a title="" href="<?php echo base_url('adverts/ad-details/'.$row['slug']); ?>">

                                         <?php $string = $row['title']; ?> <?php echo $string = character_limiter($string, 15); ?>  </a>
                                    </h3>
                                    <!-- Location -->
                                 ...
                                 <div class="panel-body">
                                    <div class="skin-minimal">
                                       <ul class="links list-unstyled">
                                                <li><a href="<?php echo base_url() ?>adverts/sub-category/Cars">Cars</a></li>
                           ...
                           <div class="panel panel-default">
                              ...
                              <div class="panel-heading" role="tab" id="headingNine">
                                 <h4 class="panel-title">
                                    ...
                                    <i class="more-less glyphicon glyphicon-plus"></i>
                                    <i class="icon fa fa-female"></i> Fashion
                                    </a>
                                 </h4>
                              </div>
                              <!-- Content -->
                              <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine">
                                 <div class="panel-body">
                                  <ul class="links list-unstyled">
                                       <li><a href="<?php echo base_url() ?>adverts/sub-category/Clothes">Clothes</a></li>
                                       <li><a href="<?php echo base_url() ?>adverts/sub-category/Shoes">Shoes</a></li>
                                       <li><a href="<?php echo base_url() ?>adverts/sub-category/Bags">Bags</a></li>
                                       <li><a href="<?php echo base_url() ?>adverts/sub-category/Jewelries">Jewelries</a></li>
                           ...
                           <div class="panel panel-default">
                              ...
                              <div class="panel-heading" role="tab" id="headingTen">
                                 <h4 class="panel-title">
                                    ...
                                    <i class="more-less glyphicon glyphicon-plus"></i>
                                    <i class="icon fa fa-plus-square"></i> Other Categories
                                    </a>
                                 </h4>
                              </div>
                              <!-- Content -->
                              <div id="collapseTen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTen">
                                 <div class="panel-body">
                                  <ul class="links list-unstyled">
                                       <li><a href="<?php echo base_url() ?>adverts/sub-category/Others">Others</a></li>
