                      ...
                      €<?php echo $english_format_number = number_format($number); ?></span> 
                                 ...
                                 <div class="ad-info-1">
                                    ...
                                    <ul class="pull-right">
                                       ...
                                       <li> <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Unmark Ad Sold" href="<?php echo base_url() ?>post/unmark-sold/<?php echo $row['post_id'] ?>"><i class="fa fa-check un-Mark Sold"></i></a> </li>
